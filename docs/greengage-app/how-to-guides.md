...
<video autoplay muted loop controls width="100%">
  <source src="/Documentation/assets/greengage-app/console/videos/create-observatory.mp4" type="video/mp4">
</video>
...
<video autoplay muted loop controls width="100%">
  <source src="/Documentation/assets/greengage-app/console/videos/define-region.mp4" type="video/mp4">
</video>
...
<video autoplay muted loop controls width="100%">
  <source src="/Documentation/assets/greengage-app/console/videos/create-observatory-menu.mp4" type="video/mp4">
</video>
...
<video autoplay muted loop controls width="100%">
  <source src="/Documentation/assets/greengage-app/console/videos/create-poi-via-task.mp4" type="video/mp4">
</video>
...
![Mission Types](/Documentation/assets/greengage-app/console/images/mission-types.png)
...
<video autoplay muted loop controls width="100%">
  <source src="/Documentation/assets/greengage-app/console/videos/delete-observatory.mp4" type="video/mp4">
</video>
