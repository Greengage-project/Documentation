...
4. [**Data ingestion and storage**](https://youtu.be/6VZLyuLVSPQ?t=216): In this step, we ingest the data from the local file to the database. In this example, we use the [Apache Druid](https://druid.16.171.94.204.nip.io/) datastore tool to ingest the data from the local file.
